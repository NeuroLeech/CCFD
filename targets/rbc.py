...
that actually have data rather than over all of them.
  ...
  python targets/rbc.py --list                      # what is available, no downloads
  python targets/rbc.py --subjects 20 --fetch       # pull and cache 20 checkerboard runs
"""
...
# this file lives in targets/, so the repository root is two levels up
RBC_ROOT = os.path.join(
    os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "data", "rbc")

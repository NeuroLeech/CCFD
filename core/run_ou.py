...
they mix onto the driven regions. That is the object a search would move.
  ...
  python core/run_ou.py                       # seed 0
  python core/run_ou.py --seed 3 --r 4 --nsteps 12000
  python core/run_ou.py --seed 0 --sponge     # absorbing medial wall instead of reflecting

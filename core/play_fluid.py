...
total, so a gain in one can be seen against a loss in another.
  ...
  python core/play_fluid.py                                    # the frozen medium, as a datum
  python core/play_fluid.py --a myelin=0.3,thickness=-0.2      # faster where myelinated
  python core/play_fluid.py --sweep myelin --target speed      # scan one coefficient
  python core/play_fluid.py --a myelin=0.3 --figure            # draw the fields it implies
"""

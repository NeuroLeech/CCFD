...
def upd(i):
    ...
    return []
# paths.VIDEOS rather than a relative "results/videos": this was the one file writing
# to a path relative to the CWD, so it only ever worked when launched from the repo root
vid_output = os.path.join(VIDEOS, "run2_v4.mp4")
